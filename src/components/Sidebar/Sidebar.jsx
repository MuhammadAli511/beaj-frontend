...
const Sidebar = () => {
    ...
    const menuSections = {
        ...
        Users: [
            ...
            { name: "Users Data", path: "/users-data", roles: ["admin", "facilitator"] },
        ...
        Content: [
            ...
            { name: "Content Ingestor", path: "/content-ingestor", roles: ["admin", "kid-lesson-creator", "teacher-lesson-creator"] },
