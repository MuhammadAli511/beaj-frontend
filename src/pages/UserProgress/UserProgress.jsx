...
//       let totalLessonsValue = null;

//       if(thresholdValue && thresholdValue > 0) {
//           totalLessonsValue = thresholdValue;
//       }
//       else{
//         totalLessonsValue = getTotalLessonsValue(maxValue);
//       }
...
//       generateChart();
//     }
//   }, [isOpen, chartType, userData, optionFilter, thresholdValue])
...
//               if (/^\d*$/.test(value)) {
//                setThresholdValue(e.target.value ? parseInt(e.target.value) : null);
//               }
//             }}
//           />
...
const ActivityChartModal = ({ isOpen, onClose, targetGroup, cohort, userData }) => {
  ...
  const generateChart = () => {
    ...
    try {
      ...
      // Limit to top 20 users for better chart readability
      // const maxDisplayUsers = 40
      // if (processedData.length > maxDisplayUsers) {
      //   processedData = processedData.slice(0, maxDisplayUsers)
      // }
      ...
      //   processedData = [
      //     {
      //       name: "No data matches current filter",
      //       value: 0,
      //       isEmpty: true,
      //     },
      //   ]
        ...
        datasets: [
          {
            ...
            borderWidth: 1,
            barPercentage: 0.8,
            // barThickness: 0.6, // Fixed bar thickness
            // maxBarThickness: 1, // Maximum bar thickness
      ...
      const options = {
        ...
        layout: {
          padding: {
            right: 50, // Add padding for value labels
            // top: 20,
            // right: 80, // More padding for value labels
            // bottom: 20,
            // left: 20,
          },
        },
